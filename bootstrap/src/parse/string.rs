...
use crate::parse::{LiteralNode, LiteralStringNode, Node, parse, Parser, StringInterpolationNode};

impl<'a> Parser<'a> {
    pub(crate) fn parse_string(&mut self) -> crate::parse::Result<Node> {
                ...
                if part.starts_with("${") {
                    ...
                    let token = Token {
                        ...
                        span: TextSpan {
                            ...
                            value: self.ctx.string_cache.insert(part.as_str()),
                        },
                    };
...
mod tests {
    ...
    use crate::lex::lex;
    use crate::parse::{InfixNode, InfixOperator, parse, StringInterpolationNode, TupleNode};
    use crate::parse::node::LiteralNode;
    use crate::parse::node::Node::Literal;
    use crate::parse::Node::StringInterpolation;
