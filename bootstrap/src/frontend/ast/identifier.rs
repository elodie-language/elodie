...
use crate::frontend::ast::{AstAccessVariableNode, AstIdentifier, AstTreeNode, Generator, SPAN_NOT_IMPLEMENTED};
...
impl<'a> Generator<'a> {
    pub(crate) fn generate_identifier(
        ...
        return Ok(AstTreeNode::new(AccessVariable(AstAccessVariableNode {
