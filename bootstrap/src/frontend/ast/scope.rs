...
//     }
//
//     pub fn insert_type(&mut self, name: StringTableId) {
//         self.types.last_mut().unwrap().insert(name, type_id);
//     }
//
//     pub fn insert_identifier(&mut self, identifier: Identifier) {
//         self.identifiers.last_mut().unwrap().insert(identifier, );
//     }
//
