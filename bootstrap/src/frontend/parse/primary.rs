...
use crate::frontend::parse::node::Node::{Break, Continue, FunctionDeclaration, If, Let, Loop, Return};
...
impl<'a> Parser<'a> {
    ...
    pub(crate) fn parse_prefix_operator(&mut self) -> crate::frontend::parse::Result<PrefixOperator> {
