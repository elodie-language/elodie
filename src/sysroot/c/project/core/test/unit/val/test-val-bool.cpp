...
TEST(val_bool_new, ok)
{
	auto tm = mem_test_new_default (64);

	struct val_bool *test_instance = val_bool_new(MEM(tm), true);
...
TEST(val_bool_equal, same_val)
{
	...
	struct val_bool *bool_one = val_bool_new(MEM(tm), true);
	struct val_bool *bool_two = val_bool_new(MEM(tm), true);
...
TEST(val_bool_equal, different_val)
{
	...
	struct val_bool *bool_one = val_bool_new(MEM(tm), true);
	struct val_bool *bool_two = val_bool_new(MEM(tm), false);
...
TEST(val_bool_to_str, true)
{
	...
	struct val_str *expected = val_str_new_from_c_str (MEM(tm), "true");
...
TEST(val_bool_to_str, false)
{
	...
	struct val_bool *test_instance = val_bool_new(MEM(tm), false);
	struct val_str *result = val_bool_to_str (test_instance, MEM(tm));
	struct val_str *expected = val_str_new_from_c_str (MEM(tm), "false");
