...
TEST(val_str_allocate_from_c_str, ok)
{
	auto tm = mem_test_new_default (128);

	struct val_str *result = val_str_allocate_from_c_str (MEM(tm), "Elodie");
...
TEST(val_str_allocate_from_bytes, ok)
{
	auto tm = mem_test_new_default (128);
	...
	struct val_str *result = val_str_allocate_from_bytes (MEM(tm), bytes);
...
TEST(val_str_allocate_from_view, ok)
{
	auto tm = mem_test_new_default (128);

	struct val_str *result = val_str_allocate_from_view (MEM(tm), val_str_view_from_c_str ("ELODIE"));
	ASSERT_EQ(6, val_str_count (result));
	ASSERT_TRUE(strncmp (result->data, "ELODIE", result->count) == 0);
...
TEST(val_str_allocate_from_byte_list, ok)
{
	auto tm = mem_test_new_default (128);
	...
	struct val_str *result = val_str_allocate_from_byte_list (MEM(tm), byte_list);
...
{
	auto test_instance = val_str_allocate_from_c_str (MEM(mem_raw_new ()), "!!Elodie Rocks!!\n");
	ASSERT_EQ(17, val_str_count (test_instance));
	val_str_deallocate_safe (&test_instance);
}

TEST(val_str_count, empty)
{
	auto test_instance = val_str_allocate_from_c_str (MEM(mem_raw_new ()), "");
...
TEST(val_str_equal, same_pointer)
{
	...
	struct val_str *test_instance = val_str_allocate_from_c_str (MEM(tm), "elodie");
...
TEST(val_str_equal, same_val)
{
	...
	struct val_str *str_one = val_str_allocate_from_c_str (MEM(tm), "elodie rockz");
	struct val_str *str_two = val_str_allocate_from_c_str (MEM(tm), "elodie rockz");
...
TEST(val_str_equal, different_val)
{
	...
	struct val_str *str_one = val_str_allocate_from_c_str (MEM(tm), "elodie");
	struct val_str *str_two = val_str_allocate_from_c_str (MEM(tm), "h4m41");
...
TEST(val_str_concat, ok)
{
	...
	struct val_str *str_one = val_str_allocate_from_c_str (MEM(tm), "Hello");
	struct val_str *str_two = val_str_allocate_from_c_str (MEM(tm), "World");

	struct val_str *expected = val_str_allocate_from_c_str (MEM(tm), "HelloWorld");
...
TEST(val_str_deallocate_safe, ok)
{
	auto tm = mem_test_new_default (128);

	struct val_str *test_instance = val_str_allocate_from_c_str (MEM(tm), "abc");
	val_str_deallocate_safe (&test_instance);
	ASSERT_TRUE(test_instance == nullptr);
