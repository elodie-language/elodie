...
string_new_from_bytes(struct mem *mem, struct bytes_view bytes);

ELODIE_API struct string *
string_new_from_c_str(struct mem *mem, char const *src);

ELODIE_API struct string *
string_new_from_byte_list(struct mem *mem, struct byte_list *src);

ELODIE_API struct string *
string_new_from_view(struct mem *mem, struct string_view view);
...
ELODIE_API void
string_free(struct string *self, struct mem *mem);
